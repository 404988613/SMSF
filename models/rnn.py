...
class TC(nn.Module):
	def __init__(self, cell="bi-lstm", vocab_size=30522, embed_size=128, hidden_dim=256, num_layers=1, class_num=2, dropout_rate=0.2):
	...
	def forward(self, inputs=None, tokenized_inputs=None, attn_mask=None, model_type=None):
		x = tokenized_inputs.long()
		embedding = self.embedding(x)
		logits, h_out = self.classifier(embedding)
