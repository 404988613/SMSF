...
class TC(nn.Module):
    def __init__(self, embed_dim=128,num_layers=1,hidden_dim=256,class_num=2,kernel_num=128,kernel_sizes=[3,4,5],vocab_size=30522,LSTM_dropout=0.2,CNN_dropout=0.2,Ci=1):
